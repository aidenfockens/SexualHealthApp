...
import { HomeContainer, BlurbContainer, HomeImg } from '../Components/Home.Styles.js'
...
const Home = () => {
    return (
        <HomeContainer>
            ...
            <HomeImg src="https://static.wikia.nocookie.net/d50917da-0a33-4c5f-9bf4-5e4b3c9d9255" />
        </HomeContainer>
    )
}
